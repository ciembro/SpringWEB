...
class TrelloClientTest {
    ...
    void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        trelloBoards[0] = new TrelloBoardDto("test_id", "Kodilla_board",  new ArrayList<>());
        ...
        assertEquals("Kodilla_board", fetchedTrelloBoards.get(0).getName());
    ...
    void shouldReturnEmptyList() throws URISyntaxException {
        ...
        //then
        assertEquals(0, fetchedBoards.size());
    }
}